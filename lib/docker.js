...
Docker.prototype.buildImage = function(verifier, name, cb) {
  debug('Building image from %s for %s', verifier, name)
  var docker = this.docker;
  docker.buildImage('', {remote: verifier, q: true, t: name}, function (err, response) {
